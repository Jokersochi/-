...
import { Loader2, X, Download, Sparkles } from 'lucide-react';
      ...
      {result && (
        <div className="mt-12 w-full max-w-4xl">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            ...
            <button
              type="button"
              className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              Оплатить (Yookassa)
            </button>
          </div>
