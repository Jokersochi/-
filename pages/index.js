...
import { Upload, Palette, Sparkles, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center p-6 text-white">
      ...
      <div className="bg-white/10 p-8 rounded-2xl shadow-2xl w-full max-w-md backdrop-blur-md border border-white/20">
        <label htmlFor="room-photo" className="flex items-center gap-2 text-sm font-medium mb-2">
          <Upload size={16} />
        ...
        <label htmlFor="design-style" className="flex items-center gap-2 text-sm font-medium mb-2">
          <Palette size={16} />
          Выберите стиль
        </label>
        <select 
