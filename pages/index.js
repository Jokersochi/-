    ...
    <div className="min-h-screen bg-black flex flex-col items-center p-6 text-white">
      ...
      <div className="bg-white/10 p-8 rounded-2xl shadow-2xl w-full max-w-md backdrop-blur-md border border-white/20">
        ...
        <select
          ...
          className="block w-full p-3 bg-gray-900 border border-white/20 rounded-xl mb-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 text-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
        >
