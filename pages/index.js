...
import { Wand2, Loader2, CreditCard, Upload, Paintbrush } from 'lucide-react';
      ...
      {result && (
        <div className="mt-12 w-full max-w-4xl">
          ...
          <div className="mt-6 flex justify-center">
             <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl transition flex items-center gap-2">
