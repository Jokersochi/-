    ...
    <div className="min-h-screen bg-black flex flex-col items-center p-6 text-white">
      ...
      <div className="bg-white/10 p-8 rounded-2xl shadow-2xl w-full max-w-md backdrop-blur-md border border-white/20">
        ...
        <button 
          ...
          disabled={loading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition duration-200 disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none flex items-center justify-center"
        >
          {loading ? (
            <>
      ...
      {result && (
        <div className="mt-12 w-full max-w-4xl">
          ...
          <div className="mt-6 flex justify-center">
             <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl transition focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none">
               Оплатить (Yookassa)
             </button>
          </div>
        </div>
