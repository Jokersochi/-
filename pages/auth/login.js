        ...
        <div className="bg-white/10 p-8 rounded-2xl shadow-2xl backdrop-blur-md border border-white/20">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-6 w-full bg-white hover:bg-gray-100 text-gray-900 font-bold py-3 rounded-xl transition flex items-center justify-center space-x-2"
            >
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <p className="mt-2">
              <Link href="/auth/reset-password" className="text-gray-400 hover:text-gray-300 text-xs">
                Забыли пароль?
              </Link>
            </p>
          </div>
